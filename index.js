...
setTimeout(() => {
    ...
    if(time.getHours()<12 && time.getHours()>=0){
        alert("Good Morning " + name + ", Hope you are doing well. Welcome to our site, we offer the best quality food at the best price.")
    }
    else if(time.getHours()>=12 && time.getHours()<=16){
        alert("Good Afternoon " + name + ", Hope you are doing well. Welcome to our site, we offer the best quality food at the best price.")
    }
    else if(time.getHours()>=16 && time.getHours()<=22){
        alert("Good Evening " + name + ", Hope you are doing well. Welcome to our site, we offer the best quality food at the best price.")
    }
    else if(time.getHours()>=22 && time.getHours()<24){
        alert("Hello " + name + ", Hope you are doing well. Welcome to our site, we offer the best quality food at the best price.")
    }
